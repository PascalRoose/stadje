...
export function ConsentBanner({ onDecide }: ConsentBannerProps) {
  return (
    ...
    >
      ...
      <p>
        Je spelvoortgang blijft altijd op je eigen apparaat staan — daar is geen
        toestemming voor nodig. Mag Stadje daarnaast anonieme bezoekstatistieken
        bijhouden?
      </p>
      ...
      <p className="consent-banner__links">
        <a href="/privacy">Privacybeleid</a> · <a href="/terms">Voorwaarden</a>
      </p>
    </div>
  );
}
